		...
		{:else}
			<div class="announcements-list">
				{#each announcements as announcement}
					<div class="announcement-card" on:click={() => openAnnouncementModal(announcement)} on:keypress={(e) => e.key === 'Enter' && openAnnouncementModal(announcement)} tabindex="0" role="button" aria-label="View announcement: {announcement.title}">
						<div class="announcement-content">
							<h2>{announcement.title}</h2>
							<p class="announcement-excerpt">{announcement.description.length > 150 ? announcement.description.slice(0, 150) + '...' : announcement.description}</p>
